...
* 用户自行安装的工具包不能被持久化，如果有持久化需求的工具包，可在K-Lab运行时内的帮助菜单下找到`工具包反馈 `，在对话框内填写工具包安装需求，我们将在2个工作日内给出答复。
![image description](/image/工具包反馈.png) ![image description](/image/工具包反馈弹窗.png)
